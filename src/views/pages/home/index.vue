	...
	<div class="home-container">
					...
					<div class="flex-margin flex">
						...
						<div class="home-card-first-right ml15">
							<div class="flex-margin">
								<div class="home-card-first-right-title">{{ currentTime }}，{{getUserInfos.account}}！</div>
		...
		<el-row :gutter="15">
			<el-col :xs="24" :sm="14" :md="14" :lg="16" :xl="16" class="mb15">
				<el-card shadow="hover" header="商品销售情况"><div style="height: 200px" ref="homeLaboratoryRef"></div></el-card>
			</el-col>
					...
					<div class="home-dynamic">
						<el-scrollbar>
							<div class="home-dynamic-item" v-for="(v, k) in activitiesList" :key="k">
								...
								<div class="home-dynamic-item-line"><i class="iconfont icon-fangkuang"></i></div>
		...
		<el-row>
			<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mt15">
				<el-card shadow="hover" header="履约超时预警"><div style="height: 200px" ref="homeOvertimeRef"></div></el-card>
			</el-col>
		</el-row>
	</div>
</template>
